        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('enrollCourse')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('leaderboards')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('learnMore')}}" class="nav-link">
