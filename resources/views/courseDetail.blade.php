                        ...
                        <table class="table table-sm">
                            <thead>
                              <tr>
                                ...
                                <th style="width: 10%">Graded at</th>
                            ...
                            <tbody>
                                    ...
                                    ?>
                                    @foreach ($assignment as $item)
                                        @if ($data->assignmentID == $item->assignmentID)
                                            @if ($data->memberID == $memberID)
                                                <?php 
                                                    $exist=true;
                                                    $title = $item->title;
                                    ...
                                    @if ($exist)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                @if ($today > $end_date)
                                                    <a href="#" class="btn btn-sm btn-danger"><i class="far fa-folder"></i> Edit Closed</a>    
                                                @else
                                                    <a href="" class="btn btn-sm btn-warning" data-toggle="modal" data-target="{{'#modal-assignmentLog'.$data->assignmentLogID}}"><i class="far fa-folder-open"></i> Edit</a>
                                                @endif
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="{{'modal-assignmentLog'.$data->assignmentLogID}}">
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h4 class="modal-title">
                                                  ...
                                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div>
                                                            Files yang telah dikumpulkan: <br>
                                                            @if ($data->filesubmitted != NULL)
                                                        ...
                                                        <form action="{{url('editSubmission/'.$data->courseID.'/'.$data->assignmentLogID.'/'.$data->assignmentID.'/'.$memberID)}}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label>File</label>
                                                                <div class="input-group">
