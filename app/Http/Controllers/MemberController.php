...
class MemberController extends Controller
{
    ...
    public function editSubmission($courseID, $assignmentLogID, $assignmentID, $memberID){
        ...
        $this->MemberModel->editSubmission($assignmentLogID,$data);
